...
public class ClientSpaceIdentifiedController {
    ...
    public void setDetails(String nomComplet, String email, String telephone, String statutAccess, String role, String dateIdentification, String avatarUrl) {
        ...
        this.dateIdentification.setText(dateIdentification != null ? dateIdentification : "N/A");

        if (avatarUrl != null && !avatarUrl.isEmpty()) {
            this.avatarImage.setImage(new Image(avatarUrl));
        } else {
